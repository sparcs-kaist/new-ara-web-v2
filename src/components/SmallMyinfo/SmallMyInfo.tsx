...
const SmallMyInfo = () => {
  ...
  return (
    <div className="p-4 bg-white rounded-[16px] shadow border border-gray-200 main-page-block-shadow">
      <Link
        href={`/myinfo`}
        className="flex items-center gap-3 mb-3 cursor-pointer rounded-lg"
      >
        <Image
